...
class MainApp:
    ...
    def __init__(self,object_name, device="auto",cam_name="D405_1280_C2",inference = False,display=False):
    ...
    def get_cam_config(self,cam_name="D405_1280_C2",config_path="cam_config.json"):
    ...
    def cam_infer(self,color_image=None, depth_image=None,bboxes=None,object_name="white_connector",Dof_6d=False,save_image=False,white_neg_x_pick_offset=0.30,
        ...
        if Dof_6d:
            ...
            center_point = self.cam_3d_infer(color_image=color_image,depth_image=depth_image,bboxes=bboxes,
                              object_name=object_name, save_image=save_image, white_neg_x_pick_offset=white_neg_x_pick_offset,
                              white_pos_x_pick_offset=white_pos_x_pick_offset,blue_neg_x_pick_offset=blue_neg_x_pick_offset,
                              blue_pos_x_pick_offset=blue_pos_x_pick_offset)
        return center_point
    ...
    def cam_6d_infer(self,color_image, depth_image, object_name,save_image,white_neg_x_pick_offset,white_pos_x_pick_offset,blue_neg_x_pick_offset,blue_pos_x_pick_offset):
        ...
        print(f"Time for 6d pose: {time.time() - time_6d} seconds")
        return self.center_point, color_image

    
    def cam_3d_infer(self, color_image, depth_image,bboxes, object_name,save_image,white_neg_x_pick_offset,white_pos_x_pick_offset,blue_neg_x_pick_offset,blue_pos_x_pick_offset):
        if not hasattr(self, 'detection_count'):
            self.detection_count = 0
        if not hasattr(self, 'no_detection_count'):
            self.no_detection_count = 0
        self.center_point = None
        rgb_image = color_image.copy()
        bbox = get_leftmost_bbox(annotations=bboxes,object_name=object_name)
