...
class YOLOv8:
    ...
    def __init__(self, onnx_model: str, input_image: str, confidence_thres: float, iou_thres: float):
        ...
        # self.classes = {0: 'blue_connector', 1: 'white_connector'}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="static_quantized.onnx", help="Input your ONNX model.")
...
# python --model static_quantized.onnx --img tiny_coco_dataset/tiny_coco/train2017/000000005802.jpg